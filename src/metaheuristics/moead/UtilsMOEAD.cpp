...
#include <jMetalCpp/metaheuristics/moead/UtilsMOEAD.h>
...
double UtilsMOEAD::distVector(double * vector1, double * vector2, int dim) {
...
void UtilsMOEAD::minFastSort(double * x, int * idx, int n, int m) {

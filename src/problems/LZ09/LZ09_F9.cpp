 ...
 * Constructor
 */
LZ09_F9::LZ09_F9(string solutionType, int ptype, int dtype, int ltype) {
  ...
  problemName_        = "LZ09_F9";
	 ...
	 LZ09_  = new LZ09(numberOfVariables_,
		...
		if (lowerLimit_ == NULL) {
			cout << "LZ09_F9::LZ09_F9: Error reserving memory for storing the "
		...
		if (solutionType.compare("BinaryReal") == 0)
			...
			cout << "LZ09_F9::LZ09_F9: solution type " << solutionType << " invalid" << endl;
			exit(-1) ;
		}

//  F20RotatedHybridComposition2GlobalOptBound.cpp
//
//  Authors:
...
// TODO: Cambiar ruta
const string F20RotatedHybridComposition2GlobalOptBound::DEFAULT_FILE_DATA = "../jMetalCpp/data/cec2005CompetitionResources/supportData/hybrid_func2_data.txt";
const string F20RotatedHybridComposition2GlobalOptBound::DEFAULT_FILE_MX_PREFIX = "../jMetalCpp/data/cec2005CompetitionResources/supportData/hybrid_func2_M_D";
...
const double F20RotatedHybridComposition2GlobalOptBound::m_lambda[NUM_FUNC] = {
  2.0*5.0/32.0, 5.0/32.0,   2.0*1,    1.0,            2.0*5.0/100.0,
  5.0/100.0,    2.0*10.0,   10.0,     2.0*5.0/60.0,   5.0/60.0
};

const double F20RotatedHybridComposition2GlobalOptBound::m_func_biases[NUM_FUNC] = {
 ...
 * Constructor.
 */
F20RotatedHybridComposition2GlobalOptBound::F20RotatedHybridComposition2GlobalOptBound(int dimension, double bias)
    : F20RotatedHybridComposition2GlobalOptBound(dimension, bias, DEFAULT_FILE_DATA, getFileMxName(DEFAULT_FILE_MX_PREFIX, dimension, DEFAULT_FILE_MX_SUFFIX)) {
 ...
 * Destructor
 */
F20RotatedHybridComposition2GlobalOptBound::~F20RotatedHybridComposition2GlobalOptBound() {
...
F20RotatedHybridComposition2GlobalOptBound::MyHCJob::MyHCJob(int numFunc)
    : HCJob(numFunc) { }

double F20RotatedHybridComposition2GlobalOptBound::MyHCJob::basic_func(int func_no, double* x, int length) {
  double result = 0.0;
  switch(func_no) {
    case 0:
    case 1:
 ...
 * Function body
 */
double F20RotatedHybridComposition2GlobalOptBound::f(double * x) {
  double result = 0.0;

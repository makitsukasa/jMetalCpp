//  F17RotatedHybridComposition1Noise.cpp
//
//  Authors:
...
// TODO: Cambiar ruta
const string F17RotatedHybridComposition1Noise::DEFAULT_FILE_DATA = "../jMetalCpp/data/cec2005CompetitionResources/supportData/hybrid_func1_data.txt";
const string F17RotatedHybridComposition1Noise::DEFAULT_FILE_MX_PREFIX = "../jMetalCpp/data/cec2005CompetitionResources/supportData/hybrid_func1_M_D";
...
const double F17RotatedHybridComposition1Noise::m_lambda[NUM_FUNC] = {
  1.0,        1.0,        10.0,       10.0,
  5.0/60.0,   5.0/60.0,   5.0/32.0,   5.0/32.0,
  5.0/100.0,  5.0/100.0
};

const double F17RotatedHybridComposition1Noise::m_func_biases[NUM_FUNC] = {
 ...
 * Constructor.
 */
F17RotatedHybridComposition1Noise::F17RotatedHybridComposition1Noise(int dimension, double bias)
    : F17RotatedHybridComposition1Noise(dimension, bias, DEFAULT_FILE_DATA, getFileMxName(DEFAULT_FILE_MX_PREFIX, dimension, DEFAULT_FILE_MX_SUFFIX)) {
 ...
 * Destructor
 */
F17RotatedHybridComposition1Noise::~F17RotatedHybridComposition1Noise() {
...
F17RotatedHybridComposition1Noise::MyHCJob::MyHCJob(int numFunc)
    : HCJob(numFunc) { }

double F17RotatedHybridComposition1Noise::MyHCJob::basic_func(int func_no, double* x, int length) {
  double result = 0.0;
  switch(func_no) {
    case 0:
    case 1:
 ...
 * Function body
 */
double F17RotatedHybridComposition1Noise::f(double * x) {
  double result = 0.0;
  ...
  result *= (1.0 + 0.2 * fabs(Benchmark::dist(Benchmark::e2)));

...
// TODO: Cambiar ruta
const string F08ShiftedRotatedAckleyGlobalOptBound::DEFAULT_FILE_DATA = "../jMetalCpp/data/cec2005CompetitionResources/supportData/ackley_func_data.txt";
const string F08ShiftedRotatedAckleyGlobalOptBound::DEFAULT_FILE_MX_PREFIX = "../jMetalCpp/data/cec2005CompetitionResources/supportData/ackley_M_D";

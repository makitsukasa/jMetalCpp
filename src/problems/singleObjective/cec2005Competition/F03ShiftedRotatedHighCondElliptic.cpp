...
// TODO: Cambiar ruta
const string F03ShiftedRotatedHighCondElliptic::DEFAULT_FILE_DATA = "../jMetalCpp/data/cec2005CompetitionResources/supportData/high_cond_elliptic_rot_data.txt";
const string F03ShiftedRotatedHighCondElliptic::DEFAULT_FILE_MX_PREFIX = "../jMetalCpp/data/cec2005CompetitionResources/supportData/Elliptic_M_D";

...
// TODO: Cambiar ruta
const string F14ShiftedRotatedExpandedScaffer::DEFAULT_FILE_DATA = "../jMetalCpp/data/cec2005CompetitionResources/supportData/E_ScafferF6_func_data.txt";
const string F14ShiftedRotatedExpandedScaffer::DEFAULT_FILE_MX_PREFIX = "../jMetalCpp/data/cec2005CompetitionResources/supportData/E_ScafferF6_M_D";

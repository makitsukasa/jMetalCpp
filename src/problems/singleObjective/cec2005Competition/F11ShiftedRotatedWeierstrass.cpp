...
// TODO: Cambiar ruta
const string F11ShiftedRotatedWeierstrass::DEFAULT_FILE_DATA = "../jMetalCpp/data/cec2005CompetitionResources/supportData/weierstrass_data.txt";
const string F11ShiftedRotatedWeierstrass::DEFAULT_FILE_MX_PREFIX = "../jMetalCpp/data/cec2005CompetitionResources/supportData/weierstrass_M_D";

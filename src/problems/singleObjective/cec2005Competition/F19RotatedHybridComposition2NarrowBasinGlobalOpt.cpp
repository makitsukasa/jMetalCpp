...
// TODO: Cambiar ruta
const string F19RotatedHybridComposition2NarrowBasinGlobalOpt::DEFAULT_FILE_DATA = "../jMetalCpp/data/cec2005CompetitionResources/supportData/hybrid_func2_data.txt";
const string F19RotatedHybridComposition2NarrowBasinGlobalOpt::DEFAULT_FILE_MX_PREFIX = "../jMetalCpp/data/cec2005CompetitionResources/supportData/hybrid_func2_M_D";

//  F21RotatedHybridComposition3.cpp
//
//  Authors:
...
#include <jMetalCpp/problems/singleObjective/cec2005Competition/F21RotatedHybridComposition3.h>

// Fixed (class) parameters
const string F21RotatedHybridComposition3::FUNCTION_NAME = "Rotated Hybrid Composition Function 3";
// TODO: Cambiar ruta
const string F21RotatedHybridComposition3::DEFAULT_FILE_DATA = "../jMetalCpp/data/cec2005CompetitionResources/supportData/hybrid_func3_data.txt";
const string F21RotatedHybridComposition3::DEFAULT_FILE_MX_PREFIX = "../jMetalCpp/data/cec2005CompetitionResources/supportData/hybrid_func3_M_D";
...
const double F21RotatedHybridComposition3::m_lambda[NUM_FUNC] = {
    5.0*5.0/100.0,  5.0/100.0,    5.0*1.0,    1.0,            5.0*1.0,
    1.0,            5.0*10.0,     10.0,       5.0*5.0/200.0,  5.0/200.0
};

const double F21RotatedHybridComposition3::m_func_biases[NUM_FUNC] = {
 ...
 * Constructor.
 */
F21RotatedHybridComposition3::F21RotatedHybridComposition3(int dimension, double bias)
    : F21RotatedHybridComposition3(dimension, bias, DEFAULT_FILE_DATA, getFileMxName(DEFAULT_FILE_MX_PREFIX, dimension, DEFAULT_FILE_MX_SUFFIX)) {
 ...
 * Destructor
 */
F21RotatedHybridComposition3::~F21RotatedHybridComposition3() {
...
F21RotatedHybridComposition3::MyHCJob::MyHCJob(int numFunc)
    : HCJob(numFunc) { }

double F21RotatedHybridComposition3::MyHCJob::basic_func(int func_no, double* x, int length) {
  double result = 0.0;
  switch(func_no) {
    case 0:
    case 1:
 ...
 * Function body
 */
double F21RotatedHybridComposition3::f(double * x) {
  double result = 0.0;

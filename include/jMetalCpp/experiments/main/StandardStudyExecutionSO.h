...
#include <jMetalCpp/experiments/settings/gGA_Settings.h>
#include <jMetalCpp/experiments/settings/ssGA_Settings.h>
#include <jMetalCpp/experiments/settings/DE_Settings.h>

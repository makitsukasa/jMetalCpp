//  F25RotatedHybridComposition4Bound.h
//
//  Authors:
...
#ifndef __F25_ROTATED_HYBRID_COMPOSITION_4_BOUND__
#define __F25_ROTATED_HYBRID_COMPOSITION_4_BOUND__
...
class F25RotatedHybridComposition4Bound : public TestFunc {
...
public:
  ...
  F25RotatedHybridComposition4Bound(int dimension, double bias);
  F25RotatedHybridComposition4Bound(int dimension, double bias, string file_data, string file_m);
...
#endif /* __F25_ROTATED_HYBRID_COMPOSITION_4_BOUND__ */

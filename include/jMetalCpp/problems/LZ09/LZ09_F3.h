...
#ifndef __LZ09_F3_H__
#define __LZ09_F3_H__
...
#include <jMetalCpp/problems/LZ09/LZ09.h>

class LZ09_F3 : public Problem {
public:
	LZ09_F3(string solutionType, int ptype=21, int dtype=1, int ltype=23);
